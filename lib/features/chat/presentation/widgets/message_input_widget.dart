                  ...
                  child: Container(
                    ...
                    child: TextField(
                      ...
                      textDirection: isTypingInArabic
                          ...
                          : TextDirection.ltr,
                      // maxLines: 6,
                      cursorColor: Constant.fontGraylight,
                ...
                InkWell(
                  child: Padding(
                    ...
                    child: Icon(
                      Icons.send,
                      color:
                          isTyping ? Constant.primaryColor : Colors.grey[400],
                    ),
                  ),
                  onTap: isTyping
                      ? () {
    ...
    return Container(
      ...
      child: IntrinsicHeight(
        child: Row(
          ...
          children: [
            Container(color: Constant.primaryDarkColor, width: 4),
